...
python3 /scripts/vcenter_consistency_tool.py --vchost $VCENTER_CONSISTENCY_HOST --vcusername $VCENTER_CONSISTENCY_USER --vcpassword $VCENTER_CONSISTENCY_PASSWORD --cinderconfig $CINDERCONFIG --novaconfig $NOVACONFIG
