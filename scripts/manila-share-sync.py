        ...
        for share in shares:
            ...
            if len(instances) == 0:
                ...
                for instance in instances:
                    ...
                    if getattr(instance, 'replica_state', None) in ['active', None]:
                        continue
